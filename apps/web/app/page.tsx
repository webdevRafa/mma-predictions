        ...
        <div className="shell relative grid gap-14 py-14 lg:min-h-[44rem] lg:grid-cols-[1.05fr_.95fr] lg:items-center lg:gap-20 lg:py-20">
          <div className="max-w-3xl">
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <Link
                className="focus-ring inline-flex min-h-12 max-w-full cursor-pointer items-center gap-2 rounded-[10px] border border-fl-accent/80 bg-fl-accent/10 px-5 text-left text-sm leading-5 font-bold text-fl-text shadow-[0_8px_24px_rgba(224,12,15,0.08)] transition hover:bg-fl-accent hover:text-fl-bg hover:shadow-[0_10px_28px_rgba(224,12,15,0.18)]"
