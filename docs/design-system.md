...
The launch system is dark-first and uses the canonical FightLobby color tokens. Fist red marks primary action; pink-red is reserved for a truly live state. Every status includes text, not color alone.
